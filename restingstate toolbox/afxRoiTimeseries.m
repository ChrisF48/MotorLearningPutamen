function [yRoi, lesioned] = afxRoiTimeseries(rois,y,subjectMasks,brainMask,XYZmm,denoisingOptions)
    ...
    for iRoi = 1:length(rois)
        ...
        switch curRoi.type
            case 'sphere'
                ...
                clear D;
            case 'image'
                dat = afxVolumeResample(curRoi.file,XYZmm,1); % CF: modified hold parameter, orig: 0
                ind = dat > 0.2;    % CF: modified orig: 0.5
                clear dat;
            case 'atlas'
